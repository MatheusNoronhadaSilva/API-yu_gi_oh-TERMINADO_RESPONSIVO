async function pegarImagens() {
    const endPoint = 'https://db.ygoprodeck.com/api/v7/cardinfo.php?type=trap%20card';
...
function criarTagImg(imagem) {
    ...
    tagImg.addEventListener('click', function() {
        ...
        h2.classList.add('mostrar')
        h21.classList.add('mostrar')
        h22.classList.add('mostrar')
        h23.classList.add('mostrar')
